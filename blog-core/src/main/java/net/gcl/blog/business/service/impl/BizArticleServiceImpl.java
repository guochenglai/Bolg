...
import net.gcl.blog.business.annotation.RedisCache;
import net.gcl.blog.business.entity.Article;
import net.gcl.blog.business.entity.User;
import net.gcl.blog.business.enums.ArticleStatusEnum;
...
import net.gcl.blog.business.service.BizArticleTagsService;
import net.gcl.blog.business.vo.ArticleConditionVO;
...
import net.gcl.blog.persistence.beans.*;
import net.gcl.blog.persistence.mapper.*;
...
public class BizArticleServiceImpl implements BizArticleService {
    ...
    public boolean updateTopOrRecommendedById(String type, Long id) {
        ...
        if ("top".equals(type)) {
            ...
            throw new BaseException(ResponseStatus.INVALID_PARAMS.getMessage());
        }
