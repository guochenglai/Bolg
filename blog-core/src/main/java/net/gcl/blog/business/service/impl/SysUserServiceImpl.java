package net.gcl.blog.business.service.impl;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import net.gcl.blog.business.entity.User;
import net.gcl.blog.business.entity.UserPwd;
import net.gcl.blog.business.enums.UserNotificationEnum;
import net.gcl.blog.business.enums.UserPrivacyEnum;
import net.gcl.blog.business.enums.UserStatusEnum;
import net.gcl.blog.business.service.SysUserService;
import net.gcl.blog.business.vo.UserConditionVO;
import net.gcl.blog.framework.exception.CommentException;
import net.gcl.blog.framework.exception.BaseException;
import net.gcl.blog.framework.holder.RequestHolder;
import net.gcl.blog.persistence.beans.SysUser;
import net.gcl.blog.persistence.mapper.SysUserMapper;
import net.gcl.blog.util.IpUtil;
import net.gcl.blog.util.PasswordUtil;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public boolean updatePwd(UserPwd userPwd) throws Exception {
        ...
        if (null == user) {
            throw new BaseException("用户编号错误！请不要手动操作用户ID！");
        }
