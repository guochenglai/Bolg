package net.gcl.blog.business.aspect;

import net.gcl.blog.business.annotation.RedisCache;
import net.gcl.blog.business.service.RedisService;
import net.gcl.blog.framework.property.AppProperties;
import net.gcl.blog.util.AspectUtil;
...
public class RedisCacheAspect {
    ...
    @Pointcut(value = "@annotation(net.gcl.blog.business.annotation.RedisCache)")
