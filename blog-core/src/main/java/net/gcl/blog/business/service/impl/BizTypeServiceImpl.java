...
import net.gcl.blog.business.entity.Type;
import net.gcl.blog.business.service.BizTypeService;
import net.gcl.blog.business.vo.TypeConditionVO;
import net.gcl.blog.framework.exception.BaseException;
import net.gcl.blog.persistence.beans.BizArticle;
import net.gcl.blog.persistence.beans.BizType;
import net.gcl.blog.persistence.mapper.BizArticleMapper;
import net.gcl.blog.persistence.mapper.BizTypeMapper;
...
public class BizTypeServiceImpl implements BizTypeService {
    ...
    public boolean removeByPrimaryKey(Long primaryKey) {
        ...
        if (!CollectionUtils.isEmpty(articles)) {
            throw new BaseException("当前分类下存在文章信息，禁止删除！");
        }
