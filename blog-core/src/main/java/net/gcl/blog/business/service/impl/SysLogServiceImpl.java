...
import net.gcl.blog.business.enums.LogLevelEnum;
import net.gcl.blog.business.enums.LogTypeEnum;
import net.gcl.blog.business.enums.PlatformEnum;
import net.gcl.blog.business.service.SysLogService;
import net.gcl.blog.business.util.WebSpiderUtils;
import net.gcl.blog.business.vo.LogConditionVO;
import net.gcl.blog.persistence.beans.SysLog;
import net.gcl.blog.persistence.mapper.SysLogMapper;
import net.gcl.blog.util.RequestUtil;
