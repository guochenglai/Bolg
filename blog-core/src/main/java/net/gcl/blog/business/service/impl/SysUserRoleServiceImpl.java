...
import net.gcl.blog.business.entity.UserRole;
import net.gcl.blog.business.service.SysUserRoleService;
import net.gcl.blog.persistence.beans.SysUserRole;
import net.gcl.blog.persistence.mapper.SysUserRoleMapper;
