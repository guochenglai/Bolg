...
import net.gcl.blog.business.entity.MailDetail;
import net.gcl.blog.business.entity.Template;
...
import net.gcl.blog.business.service.SysTemplateService;
import net.gcl.blog.util.FreeMarkerUtil;
