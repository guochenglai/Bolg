...
public class BeanConvertUtil {
    ...
    public static <T> T doConvert(Object source, Class<T> target) {
        ...
        try {
            ...
            throw new BaseException(target + " - 可能为一个抽象类、接口、数组类、基本类型或者该类缺少无参构造方法！", e);
        } catch (IllegalAccessException e) {
            throw new BaseException(target + " - 该类或其构造方法是不可访问的，或该类缺少无参构造方法！", e);
        } catch (FatalBeanException e) {
            throw new BaseException(target + " - 序列化失败！", e);
        }
    }
