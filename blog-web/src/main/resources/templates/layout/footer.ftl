    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="padding: 5px 15px;">
                ...
                <h4><i class="fa fa-search"></i> Search Articles</h4>
            </div>
            <div class="modal-body">
                <form action="/" method="post" class="form-horizontal searchForm" id="searchForm">
                    ...
                    <ul class="list-unstyled list-inline search-hot">
                        <li><strong style="position: relative;top: 2px;color: #999999;">Suggestion：</strong></li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="comment-detail-modal-label">Your Infomation</h4>
            </div>
            <div class="modal-body">
                <form id="detail-form">
                    <input type="hidden" name="avatar">
                    <div class="form-group input-logo">
                        <input type="text" class="form-control" name="nickname" placeholder="Required" value="anonymous">
        ...
        <div class="container">
            <div class="row">
                <div class="col col-xs-12 col-md-12 col-lg-12">
                    <p><#if config.copyright!>${config.copyright} |</#if> Powered by <a href="https://guochenglai.com" data-toggle="tooltip" data-placement="right" target="_blank" style="color: #4286ca;font-weight: 600;">Guo Chenglai</a>  </p>
                    <#if url?? && (url == "index")>
...
<a class="to-top" title="To The Top" data-toggle="tooltip" data-placement="bottom"></a>
