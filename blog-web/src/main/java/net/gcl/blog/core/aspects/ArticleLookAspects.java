package net.gcl.blog.core.aspects;

import net.gcl.blog.business.entity.ArticleLook;
import net.gcl.blog.core.schedule.ArticleLookTask;
...
public class ArticleLookAspects {
    ...
    @Pointcut("execution(* net.gcl.blog.controller.RenderController.article(..))")
