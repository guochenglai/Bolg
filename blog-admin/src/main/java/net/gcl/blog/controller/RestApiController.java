...
import net.gcl.blog.core.websocket.server.BaseWebsocketServer;
import net.gcl.blog.core.websocket.util.WebSocketUtil;
...
public class RestApiController {
    ...
    @Autowired
    private BaseWebsocketServer websocketServer;
