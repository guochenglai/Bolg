package net.gcl.blog.core.config;

import net.gcl.blog.core.shiro.ShiroService;
import net.gcl.blog.core.shiro.credentials.RetryLimitCredentialsMatcher;
import net.gcl.blog.core.shiro.realm.ShiroRealm;
import net.gcl.blog.framework.property.RedisProperties;
import net.gcl.blog.framework.property.ShiroProperties;
import net.gcl.blog.framework.redis.CustomRedisManager;
